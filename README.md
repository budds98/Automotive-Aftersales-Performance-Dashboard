...
3. Since the dataset is large, all cleaned data is loaded into a PostgreSQL database using Python for efficient storage and data management.

4. For data visualization and analysis, PostgreSQL is connected to Power BI to build dashboards that analyze key workshop business metrics.
