# Automotive-General-Repair-Workshop-Performance-Dashboard
...
4. Since the dataset is large, all cleaned data is loaded into a PostgreSQL database using Python for efficient storage and data management.
   ...
   ![Alt text atau deskripsi gambar](https://github.com/budds98/Automotive-Aftersales-Performance-Dashboard/blob/main/python-02.jpg)
